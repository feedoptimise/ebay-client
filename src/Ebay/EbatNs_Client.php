...
{ 
	...
	{
		if (!isset($this->_loggingOptions['LOG_TIMEPOINTS']) OR !$this->_loggingOptions['LOG_TIMEPOINTS'])
			return;
	...
	{
		if (!isset($this->_loggingOptions['LOG_API_USAGE']) OR !$this->_loggingOptions['LOG_API_USAGE'])	
			return;
